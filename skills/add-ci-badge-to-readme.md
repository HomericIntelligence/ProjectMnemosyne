...
description: 'Add a GitHub Actions CI status badge to a README. Use when: a README
  is missing a CI badge, a new workflow should be surfaced via a badge, or a reviewer
  requests build status visibility.'
