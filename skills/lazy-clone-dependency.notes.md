...
## Issue
[ProjectScylla #1324](https://github.com/HomericIntelligence/ProjectScylla/issues/1324) — `plan_issues.py` was silently skipping the advise step when Mnemosyne was absent.

## Symptom
```
2026-03-03 06:36:36 [WARNING] scylla.automation.planner: Mnemosyne not found, skipping advise step
