...
description: 'Fix overlapping test group patterns in GitHub Actions matrix workflows.
  Use when: CI test files run in multiple jobs due to wildcard overlap, or a parent
  group wildcard subsumes dedicated child groups.'
category: ci-cd
date: 2026-03-08
version: 1.0.0
