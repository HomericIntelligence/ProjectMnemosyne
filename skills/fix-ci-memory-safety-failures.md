...
description: Diagnose and fix CI failures caused by memory safety issues in Mojo,
  particularly UnsafePointer access through copied structs and Python FFI interference.
  Use when seeing segfaults in libKGENCompilerRTShared.so or tests pass locally but
  fail in CI.
category: debugging
date: 2026-01-24
version: 1.0.0
