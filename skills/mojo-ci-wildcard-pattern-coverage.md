...
description: 'Determine if CI workflow test patterns need updating after adding/splitting
  Mojo test files. Use when: adding test_*.mojo files or splitting test files and
  unsure if CI auto-discovers the new files.'
category: ci-cd
date: 2026-03-08
version: 1.0.0
