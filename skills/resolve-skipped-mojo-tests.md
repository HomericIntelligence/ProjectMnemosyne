...
description: 'Re-enable disabled Mojo test files by identifying root causes and replacing
  stubs with actual tests. Use when: a Mojo test file prints SKIPPED, has a NOTE about
  type system issues, or references a non-existent module.'
category: testing
date: 2026-03-04
version: 1.0.0
