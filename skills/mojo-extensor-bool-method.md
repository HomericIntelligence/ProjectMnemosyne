...
description: 'Implement __bool__ on a Mojo tensor/struct for single-element truthiness.
  Use when: adding Python/NumPy/PyTorch-compatible boolean context to a Mojo struct,
  un-commenting placeholder tests for __bool__, or following up on existing item()/__int__/__float__
  implementations.'
