...
description: 'Standardize Mojo language/compiler limitation NOTEs to use consistent
  `# NOTE (Mojo vX.Y.Z):` format. Use when: cleaning up docs with inconsistent NOTE
  formats, auditing Mojo codebases, or implementing cleanup issues requiring NOTE
  standardization.'
