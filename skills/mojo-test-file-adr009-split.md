...
description: 'Split Mojo test files exceeding ADR-009 limit (10 fn test_ per file)
  to prevent heap corruption. Use when: CI fails non-deterministically with libKGENCompilerRTShared.so
  JIT fault, or a test file has >10 fn test_ functions.'
category: ci-cd
date: 2026-03-08
version: 1.0.0
