...
description: "Split Mojo test files exceeding ADR-009 limit (\u226410 fn test_ per\
  \ file) to fix heap corruption CI failures. Use when: (1) CI shows intermittent\
  \ heap corruption crashes, (2) a test file has >10 fn test_ functions, (3) ADR-009\
