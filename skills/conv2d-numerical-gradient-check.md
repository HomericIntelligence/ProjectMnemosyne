...
description: 'Add numerical gradient checks for conv2d_backward grad_input and grad_weights
  using finite differences. Use when: (1) a conv backward pass lacks numerical validation,
  (2) verifying transposed convolution gradient correctness, (3) extending existing
  conv backward tests with gradient checking.'
category: testing
date: 2026-03-07
version: 1.0.0
