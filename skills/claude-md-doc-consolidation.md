...
description: 'Trim duplicate documentation sections in CLAUDE.md by replacing verbose
  content with a summary + link to canonical docs. Use when: CLAUDE.md has sections
  duplicating docs/ content, file is too large, or consolidating multiple doc locations.'
