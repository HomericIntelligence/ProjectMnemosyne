...
description: 'Fix negative-step slice bugs in Mojo __getitem__(Slice). Use when: reverse
  slicing returns empty or wrong results, result_size is 0 for t[::-1], or slice defaults
  are wrong for negative step.'
category: debugging
date: 2026-03-07
version: 1.0.0
