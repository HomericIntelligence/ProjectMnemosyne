...
description: 'Pattern for adding ConfusionMatrix integration tests to a Mojo ValidationLoop
  test file. Use when: a ValidationLoop accepts compute_confusion=True but has no
  test covering that path, or you need to verify exact ConfusionMatrix cell counts
  with known binary fixtures.'
category: testing
date: 2026-03-07
version: 1.0.0
