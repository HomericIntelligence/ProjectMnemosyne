...
description: 'Update blocked NOTE comments with issue tracking references. Use when:
  a NOTE/TODO documents a feature blocked by an unresolved external dependency, a
  cleanup issue asks to update blocker comments, or pre-commit mojo-format fails due
  to GLIBC incompatibility in the local environment.'
