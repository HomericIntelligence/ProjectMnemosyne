...
description: 'Fix YAML frontmatter parsers that use manual line.split('':'', 1) instead
  of yaml.safe_load(), which silently truncates values containing colons. Use when:
  auditing frontmatter parsers for colon-split bugs, adding regression tests for URL/ratio
  values in YAML fields, or fixing description fields that lose data after the first
  colon.'
category: testing
date: 2026-03-15
version: 1.0.0
