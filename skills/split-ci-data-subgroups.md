...
description: 'Promote a fragile explicit-list CI matrix group into dedicated leaf
  sub-groups with wildcard auto-discovery. Use when: (1) a matrix group enumerates
  subdirectory patterns explicitly causing silent test-miss risk, (2) new test files
  are not picked up automatically, (3) restoring wildcard test_*.mojo patterns at
  leaf paths.'
category: ci-cd
date: 2026-03-15
version: 1.0.0
