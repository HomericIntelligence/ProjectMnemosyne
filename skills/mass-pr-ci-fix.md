---
name: mass-pr-ci-fix
description: 'Fix CI failures across many open PRs systematically. Use when: many
  PRs share a common CI failure, pre-commit mojo format fails after codebase changes,
  Mojo trait API breaks compilation across branches.'
category: ci-cd
date: 2026-03-07
version: 1.0.0
