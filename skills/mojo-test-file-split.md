...
description: 'Split large Mojo test files exceeding ADR-009 fn test_ function limits
  to prevent heap corruption in CI. Use when: a test file has >10 fn test_ functions
  causing intermittent libKGENCompilerRTShared.so JIT faults.'
category: ci-cd
date: 2026-03-08
version: 1.0.0
