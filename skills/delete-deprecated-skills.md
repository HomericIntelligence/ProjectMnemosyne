...
description: 'Delete deprecated skill directories and update all cross-references.
  Use when: skills reference removed systems, cleanup issues list DEPRECATED-marked
  skills, or planning-system migration leaves orphaned skill files.'
category: tooling
date: 2026-03-05
version: 1.0.0
