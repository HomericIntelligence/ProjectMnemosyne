...
description: 'Align pre-commit hook versions with pixi/conda resolved package versions
  to eliminate local vs CI behavior drift. Use when: pre-commit rev differs from pixi.toml
  version, or linter behavior differs between pre-commit and pixi run.'
category: ci-cd
date: 2026-03-07
version: 1.0.0
