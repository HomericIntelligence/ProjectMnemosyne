...
description: Configure Claude Code settings.json per test workspace to control thinking
  mode via API rather than prompt injection. Use when implementing workspace-level
