...
description: "Split Mojo test files exceeding \u226410 fn test_ limit to fix ADR-009\
  \ heap corruption in CI. Use when: (1) a Mojo test file has >10 fn test_ functions,\
  \ (2) CI has intermittent non-deterministic heap crashes, (3) enforcing ADR-009\
  \ compliance."
category: ci-cd
date: 2026-03-07
version: 1.0.0
