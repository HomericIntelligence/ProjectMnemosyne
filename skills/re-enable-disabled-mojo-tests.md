...
description: 'Re-enable disabled Mojo test files by investigating root cause and replacing
  stubs with real tests. Use when: a .mojo test file has a NOTE saying tests are disabled,
  a test file only prints SKIPPED, or cleanup issues ask to re-enable tests.'
category: testing
date: 2026-03-05
version: 1.0.0
