...
description: 'Fix batch norm backward gradient tests failing with uniform upstream
  gradients. Use when: batch_norm_backward gradient check fails with analytical~=0
  but numerical!=0 due to sum(x_norm)=0 cancellation.'
category: testing
date: 2026-03-05
version: 1.0.0
