...
description: "Systematically fix multiple failing PRs with pre-commit hook failures\
  \ \u2014 covers auto-format fixes, expanded-scope self-catch scenarios, merge conflict\
  \ resolution, and BAD_PATTERNS rebase regressions"
category: ci-cd
date: 2026-03-08
version: 1.0.0
