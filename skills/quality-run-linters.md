...
description: Run all configured linters including mojo format, markdownlint, and pre-commit
  hooks. Use before committing code to ensure quality standards are met.
category: tooling
date: '2026-03-19'
version: 1.0.0
mcp_fallback: none
