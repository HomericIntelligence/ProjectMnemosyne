...
description: Fix CI failures caused by missing YAML frontmatter in SKILL.md files.
  Use when plugin validation fails with 'missing YAML frontmatter' errors across multiple
  PRs.
category: ci-cd
date: 2026-01-08
version: 1.0.0
