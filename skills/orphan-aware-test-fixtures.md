...
description: 'Patterns for fixing test fixtures that break when checkpoint integrity
  detectors are added. Use when: adding orphan detection to resume pipelines, or when
  aggregated states get unexpectedly reset.'
category: testing
date: 2026-03-17
version: 1.0.0
