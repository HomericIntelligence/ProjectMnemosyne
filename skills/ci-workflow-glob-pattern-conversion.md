...
description: 'Convert explicit filename lists in CI workflow test groups to wildcard
  glob patterns for auto-discovery. Use when: CI test groups have explicit filenames
  that miss new ADR-009 split files, or when workflows need manual updates every time
  tests are added.'
category: ci-cd
date: 2026-03-15
version: 1.0.0
