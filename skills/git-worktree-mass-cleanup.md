...
description: 'Remove all git worktrees in bulk, distinguishing merged vs active PRs,
  cleaning untracked dirs, and switching main checkout to main. Use when: accumulated
  worktrees need purging after parallel development, or resetting repo to clean single-checkout
  state.'
category: tooling
date: 2026-03-06
version: 1.0.0
