...
description: 'Wire Mojo structs through a multi-level __init__.mojo re-export chain
  and expose canonical type aliases at the package root. Use when: (1) a struct exists
  in a leaf module but is missing from parent package imports, (2) plan-canonical
  names differ from implementation struct names.'
