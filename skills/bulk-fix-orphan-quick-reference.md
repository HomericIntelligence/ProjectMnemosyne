...
description: 'Bulk-fix SKILL.md files with orphaned top-level ## Quick Reference sections
  alongside ## Verified Workflow. Use when: validate_plugins.py reports Quick Reference
  warnings across many files.'
category: tooling
date: 2026-03-15
version: 1.0.0
