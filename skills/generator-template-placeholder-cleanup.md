...
description: 'Review TODO comments in code generator scripts and reclassify as TEMPLATE:
  markers or actual work items. Use when: cleaning up generator scripts, distinguishing
  template scaffolding from implementation gaps, or working on TODO-review issues.'
