...
description: 'Migrate duplicated test fixture configs to a centralized shared location.
  Use when: test fixtures have duplicated configs, find | md5sum shows 40+ duplicates,
  configs are test-independent.'
