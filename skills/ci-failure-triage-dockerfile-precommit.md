...
description: 'Diagnose and fix CI failures from Dockerfile GID collisions and pre-commit
  hook arg-passing bugs. Use when: Docker builds fail with ''GID already exists'',
  pre-commit hooks scan entire repo unexpectedly, or bash -c entry hooks silently
  lose filenames.'
category: ci-cd
date: 2026-03-16
version: 1.0.0
