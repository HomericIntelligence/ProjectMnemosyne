...
description: 'Documents how to add narrowing conversion tests in Mojo following the
  if/raise pattern. Use when: (1) adding UInt narrowing tests for a new target type,
  (2) extending test_unsigned.mojo with new cast coverage.'
category: testing
date: 2026-03-15
version: 1.1.0
