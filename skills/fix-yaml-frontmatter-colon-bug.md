...
description: 'Fix YAML frontmatter parsing bugs where line.partition('':'') silently
  truncates values containing colons. Use when: migrating a manual-split frontmatter
  parser to yaml.safe_load() following the partition-colon bug pattern.'
category: ci-cd
date: 2026-03-15
version: 1.0.0
