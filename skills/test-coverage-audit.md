...
description: 'Audit existing test files before adding new tests to avoid duplicating
  coverage. Use when: an issue requests adding tests for a method, investigating whether
  a test coverage gap is real, or consolidating test suites.'
category: testing
date: 2026-03-15
version: 1.0.0
