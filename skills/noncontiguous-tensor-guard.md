...
description: 'Add as_contiguous() guards to Mojo flat-buffer kernels so non-contiguous
  tensor views don''t silently produce wrong results. Use when: a kernel uses _data.bitcast[T]()[i]
  flat indexing, adding support for transposed/sliced tensor inputs, or auditing kernels
  after a new non-contiguous tensor API is introduced.'
category: testing
date: 2026-03-15
version: 1.0.0
