...
description: 'Workflow for implementing small, well-specified documentation edits
  in a worktree. Use when: (1) issue specifies exact insert location, (2) change is
  adding a note/clarification to markdown, (3) single targeted Edit with pre-commit
  verification.'
