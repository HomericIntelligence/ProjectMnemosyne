...
description: 'Fix E2E experiment runner hanging and ignoring Ctrl+C/Ctrl+Z signals
  during parallel execution. Use when: manage_experiment.py hangs, signals are ignored,
  or SIGTSTP does graceful shutdown instead of force kill.'
category: debugging
date: 2026-03-18
version: 1.0.0
