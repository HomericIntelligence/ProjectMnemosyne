...
description: 'Implement standard utility methods on a Mojo tensor class. Use when:
  adding Python/NumPy-compatible dunder methods to a Mojo struct, implementing type-erased
  tensor accessors, or auditing existing methods before implementing new ones.'
