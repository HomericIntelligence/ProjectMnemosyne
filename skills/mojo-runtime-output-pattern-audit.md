...
description: 'Audit Mojo source files for misleading runtime print() patterns and
  wire CI enforcement. Use when: extending an existing audit series to cover WARNING:,
  HACK:, XXX:, or Not implemented in print() calls; adding a grep-style checker script
  modeled on an existing one; or enforcing runtime output cleanliness in a Mojo project.'
category: tooling
date: 2026-03-15
version: 1.0.0
