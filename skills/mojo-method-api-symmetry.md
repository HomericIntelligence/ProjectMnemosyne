...
description: 'Add thin method wrappers to Mojo structs to complete API symmetry with
  free functions. Use when: (1) a free function was exported but no struct method
  wrapper exists, (2) closing follow-up API symmetry issues after a larger feature
  PR, (3) auditing a struct for missing parity with module-level functions.'
