...
description: "Patterns for testing RuntimeError guards in subprocess-wrapping classes\
  \ \u2014 covers state guards (no mock needed), sequential subprocess side_effect\
  \ lists, and bypassing earlier guards to test later ones. Used in ProjectScylla\
  \ WorkspaceManager."
category: testing
date: '2026-03-19'
version: 1.0.0
