...
description: "TRIGGER CONDITIONS: Adding a --dry-run flag to a CLI script that exits\
  \ 1 on errors. Use when developers need to preview all violations/errors across\
  \ many files without blocking a pre-commit hook or CI step \u2014 especially during\
  \ bulk config migrations or refactors."
category: tooling
date: 2026-03-07
version: 1.0.0
