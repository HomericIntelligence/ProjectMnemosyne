...
description: 'Detect when a GitHub issue was already implemented in a previous session
  and has an open PR. Use when: implementing a GitHub issue, session starts on a branch
  with commits, or a PR already exists for the issue.'
