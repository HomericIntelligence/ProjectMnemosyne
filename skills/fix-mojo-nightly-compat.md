...
description: Fix compilation errors and deprecation warnings caused by Mojo stable
  vs nightly version mismatches, including string indexing, alias/comptime changes,
  and format tool compatibility
category: debugging
date: 2026-03-10
version: 1.0.0
