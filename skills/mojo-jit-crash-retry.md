...
description: 'Diagnose and fix intermittent Mojo JIT compiler crashes in CI. Use when:
  Mojo tests report ''execution crashed'' before printing any output, crash stack
  shows libKGENCompilerRTShared.so, same test passes/fails non-deterministically.'
category: ci-cd
date: 2026-03-05
version: 1.0.0
