...
description: 'Pattern for extending a rank-restricted Mojo __getitem__(Slice) to N-D
  tensors with axis-0 semantics. Use when: a Mojo tensor raises an error for non-1D
  slicing but the logic generalises to higher ranks.'
