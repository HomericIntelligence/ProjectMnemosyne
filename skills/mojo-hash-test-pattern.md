...
description: 'Skill: mojo-hash-test-pattern. Use when: adding tests to verify that
  __hash__ on a Mojo tensor type differentiates by dtype even when logical values
  are identical, or confirming that dtype_to_ordinal is included in hash computation.'
category: testing
date: 2026-03-07
version: 1.0.0
