...
description: Implement post-merge recommendations from a chief architect or code review
  covering documentation gaps, test coverage gaps, comment accuracy, and rebase with
  conflict resolution
