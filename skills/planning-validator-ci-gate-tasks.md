...
- `planning-verify-issue-premise-before-implementing` — runs-vs-gates distinction,
  grep-the-claim discipline, infrastructure-assumption verification, and `git ls-files`
  scan scoping before building a required gate.
