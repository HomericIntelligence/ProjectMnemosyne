...
description: 'Pattern for testing multi-channel Conv2D backward passes in Mojo with
  analytically tractable gradient verification. Use when: adding backward pass tests
  for conv layers with multiple input/output channels, verifying grad_input/grad_weights/grad_bias
  shapes and values.'
category: testing
date: 2026-03-07
version: 1.0.0
