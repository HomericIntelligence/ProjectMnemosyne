...
description: "Split large Mojo test files into \u226410 fn test_ per file to fix heap\
  \ corruption CI crashes. Use when: Mojo test file exceeds 10 fn test_ functions,\
  \ CI shows intermittent libKGENCompilerRTShared.so crashes."
category: ci-cd
date: 2026-03-07
version: 1.0.0
