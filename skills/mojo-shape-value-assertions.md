...
description: 'Add value-correctness assertions to Mojo tensor shape tests. Use when:
  shape tests only check element counts/dimensions but not actual values, or code
  review flags tests that pass even if operations produce wrong output.'
category: testing
date: 2026-03-07
version: 1.0.0
