...
description: 'Centralize shared constants to their canonical module and update importers.
  Use when: duplicate constants exist across modules, or a higher-level module defines
  values that belong in a lower-level dependency.'
