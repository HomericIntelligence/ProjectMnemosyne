...
description: "Patterns for testing if-None RuntimeError precondition guards in Python\
  \ \u2014 covers unit test structure, parametrized fixtures, closure guards via action\
  \ builders, inline run() guards with side-effect patching, and the local-import\
  \ patch target rule."
category: testing
date: '2026-03-19'
version: 1.1.0
