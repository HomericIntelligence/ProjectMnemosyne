...
description: 'CI/CD speedup via path filters, hook deduplication, job inlining, and
  timing collection. Use when: CI runs unnecessarily on doc PRs, pre-commit duplicates
  CI jobs, or serial single-command jobs add runner overhead.'
category: ci-cd
date: 2026-03-14
version: 1.0.0
