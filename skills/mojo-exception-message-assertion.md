...
description: 'Pattern for asserting exact error message text in Mojo exception tests
  using ''except e:''. Use when: (1) upgrading bare except: clauses to assert specific
  error message text, (2) adding message verification to out-of-bounds or error-path
  tests.'
category: testing
date: 2026-03-07
version: 1.0.0
