...
description: 'Pattern for testing Mojo __hash__ determinism by hashing the same instance
  multiple times. Use when: verifying hash stability for edge-case tensors, confirming
  no side effects from repeated hash calls.'
category: testing
date: 2026-03-15
version: 1.0.0
