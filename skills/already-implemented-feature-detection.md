...
description: 'Verify whether GitHub issue requirements are already fully implemented
  before starting work. Use when: implementing a GitHub issue on a branch that may
  have prior commits, or when a PR already exists for the issue.'
category: tooling
date: 2026-03-05
version: 1.0.0
