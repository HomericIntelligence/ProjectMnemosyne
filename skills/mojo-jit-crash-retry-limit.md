...
description: 'Add retry limit and distinct failure messages to just test-group crash
  retry. Use when: blind retry-all loop needs to be replaced with crash-aware retry,
  or CI logs cannot distinguish retry-exhausted from normal failures.'
category: ci-cd
date: 2026-03-07
version: 1.0.0
