...
description: 'Add numerical gradient checks for conv2d_backward in Mojo using check_gradient
  with finite differences. Use when: conv2d backward tests only validate shapes but
  not grad_input or grad_weights values numerically.'
category: testing
date: 2026-03-07
version: 1.0.0
