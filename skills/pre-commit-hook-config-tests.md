...
description: 'Write pytest unit tests that verify pre-commit hook configuration from
  YAML. Use when: a security hook has an intentional skip list needing rationale,
  verifying files: pattern coverage, or ensuring suppressions reflect real codebase
  usage.'
category: testing
date: 2026-03-07
version: 1.0.0
