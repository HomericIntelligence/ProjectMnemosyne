...
description: 'Pattern for testing that training/validation loops reset DataLoaders
  before iterating, using a pre-exhaustion strategy. Use when: adding tests for loop
  reset behavior, verifying run() or run_subset() semantics, or writing parallel tests
  across loop methods.'
category: testing
date: 2026-03-15
version: 1.0.0
