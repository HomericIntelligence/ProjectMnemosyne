...
description: 'Document trait-implementing special methods in Mojo struct docstrings
  and package __init__.mojo API listings. Use when: a new dunder method is added to
  a Mojo struct but not mentioned in docs or the package module listing.'
