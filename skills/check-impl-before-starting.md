...
description: 'Check if an issue''s implementation already exists before starting work.
  Use when: implementing an issue on a pre-existing branch, resuming interrupted work,
  or verifying PR status before creating duplicates.'
category: tooling
date: 2026-03-05
version: 1.0.0
