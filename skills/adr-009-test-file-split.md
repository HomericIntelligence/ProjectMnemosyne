...
description: 'Split Mojo test files exceeding the ADR-009 limit of 10 fn test_ functions
  per file. Use when: (1) CI shows intermittent heap corruption crashes in a Mojo
  test group, (2) a test file has >10 fn test_ functions, (3) implementing ADR-009
  compliance.'
category: ci-cd
date: 2026-03-08
version: 1.0.0
