...
description: 'Replace placeholder documentation with accurate, verified content grounded
  in the actual codebase. Use when: a doc file contains stub text, a getting-started
  guide needs real commands, or a quickstart links to non-existent paths.'
