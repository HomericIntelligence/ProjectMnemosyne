...
description: 'Fix git worktree path extraction from porcelain output. Use when: parsing
  worktree list, extracting paths by branch, managing multiple worktrees.'
category: tooling
date: 2026-03-09
version: 1.0.0
