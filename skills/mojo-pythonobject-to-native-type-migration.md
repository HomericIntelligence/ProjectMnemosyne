...
description: 'Migrate Mojo function signatures from PythonObject placeholder parameters
  to native Mojo struct types. Use when: a function accepts PythonObject as a temporary
  placeholder pending interop infrastructure, and the native struct is now ready.'
