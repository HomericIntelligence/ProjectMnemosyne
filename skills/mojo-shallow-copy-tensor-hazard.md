...
description: 'Fix Mojo tensor mutation caused by shallow copy sharing _data pointer.
  Use when: a function mutates a tensor copy but silently corrupts the caller''s original
  tensor.'
category: debugging
date: 2026-03-07
version: 1.0.0
