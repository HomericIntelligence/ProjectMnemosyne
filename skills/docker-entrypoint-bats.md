...
description: 'Skill: docker-entrypoint-bats. Use when adding BATS tests for Docker
  entrypoint scripts that handle credential chains, environment validation, and command
  dispatch.'
category: testing
date: 2026-03-03
version: 1.0.0
