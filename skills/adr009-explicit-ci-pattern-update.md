...
description: 'ADR-009 test file split when CI uses explicit filename patterns. Use
  when: splitting a Mojo test file whose CI group lists filenames explicitly (not
  glob), requiring workflow file updates alongside test file creation.'
category: ci-cd
date: 2026-03-07
version: 1.0.0
