...
description: 'Add numerical gradient checks for conv2d_backward with padding > 0 in
  Mojo. Use when: (1) existing conv backward tests only cover padding=0, (2) need
  to exercise boundary handling in transposed convolution for grad_input, (3) extending
  padding coverage to padding=1 and padding=2.'
category: testing
date: 2026-03-15
version: 1.0.0
