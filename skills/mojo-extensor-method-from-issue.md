...
description: 'Pattern for adding stride-view methods to ExTensor and migrating tests
  from standalone-function workarounds to method-syntax. Use when: implementing ExTensor
  methods that replace workarounds, updating tests with stride-mutation hacks, or
  encountering deprecated List syntax in docstring examples.'
category: tooling
date: 2026-03-07
version: 1.0.0
