...
description: 'Fix Mojo __hash__ for float-containing structs using UnsafePointer bitcast
  for exact IEEE 754 bit representation. Use when: float hash collisions occur for
  large/small values, or __hash__ uses lossy integer approximation.'
category: debugging
date: 2026-03-05
version: 1.0.0
