...
description: 'Ensure test count badge stays accurate when a large test file is split
  into multiple parts. Use when: a test file has been split into part1/part2/etc.
  and the badge-check script must count all parts.'
category: testing
date: 2026-03-15
version: 1.0.0
