...
description: 'Pattern for verifying Conv2D backward-pass gradient accumulation over
  the batch dimension in Mojo. Use when: adding batch>1 backward tests for conv layers,
  verifying grad_bias = batch * out_H * out_W, verifying grad_weights accumulates
  over multiple batch items.'
category: testing
date: 2026-03-15
version: 1.0.0
