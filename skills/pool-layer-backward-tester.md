...
description: 'Implement a pooling backward pass tester following the three-tier gradient
  checking pattern (shape, analytical, numerical). Use when: adding test_pool_layer_backward
  to a Mojo layer_testers utility, validating MaxPool/AvgPool backward pass gradients,
  or filling a gap where conv/batchnorm backward testers exist but pooling backward
  is absent.'
category: testing
date: 2026-03-15
version: 1.0.0
