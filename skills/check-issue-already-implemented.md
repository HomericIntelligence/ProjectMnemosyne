...
description: 'Check if a GitHub issue was already implemented in a previous session.
  Use when: starting work on a branch that already exists, running an impl skill that
  finds clean working tree with recent commits, or when a PR already exists for the
  issue.'
category: tooling
date: 2026-03-05
version: 1.0.0
