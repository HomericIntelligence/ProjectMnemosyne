...
description: Add a contiguous-memcpy fast-path for N-D tensor slices where only the
  first axis is non-trivially sliced. Use when optimizing batch-extraction in training
  loops.
