...
| **History** | v1.0.0 → v2.0.0 (MAJOR: worked-example conclusion overturned) → v2.1.0 (MINOR: self-contained-vs-blocked-on-merge step + vendor-fixes-latent-bugs lesson) → v2.2.0 (MINOR: prerequisite MERGE-STATE verification for auto-generated follow-up issues + ProjectProteus #182 instance). See `planning-verify-issue-premise-before-implementing.history`. |
