...
description: 'Deduplicate repeated Pixi setup blocks across GitHub Actions workflows
  using a composite action. Use when: consolidating CI workflows, replacing inline
  prefix-dev/setup-pixi with a shared composite action, or merging security/audit
  workflows.'
category: ci-cd
date: 2026-03-07
version: 1.0.0
