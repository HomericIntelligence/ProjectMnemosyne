...
description: 'Replace placeholder README.md with accurate project description by exploring
  the live codebase. Use when: README has placeholder text, project has outgrown its
  docs, or a new contributor needs to understand quickly.'
