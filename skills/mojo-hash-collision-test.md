...
description: 'Pattern for adding hash collision tests to Mojo ExTensor test files.
  Use when: (1) issue requests verifying hash distinguishes same-dtype tensors with
  different shapes, (2) verifying __hash__ distinguishes float32 vs float64 tensors,
  (3) adding collision tests for shape/dtype/value sensitivity.'
category: testing
date: 2026-03-15
version: 1.1.0
