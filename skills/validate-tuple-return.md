...
description: 'Refactor Mojo validation functions to return Tuple[Float64, Float64]
  (loss, accuracy) to eliminate redundant data loader passes. Use when: validate()
  discards accuracy internally and the caller re-computes it with a second loop.'
