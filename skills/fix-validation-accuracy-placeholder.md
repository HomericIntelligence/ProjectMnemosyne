...
description: 'Fix hardcoded 0.0 accuracy placeholders in validation loop methods by
  wiring real AccuracyMetric accumulation per batch. Use when: a validation method
  passes a literal 0.0 for accuracy to a metrics update call instead of computing
  it.'
category: evaluation
date: 2026-03-15
version: 1.0.0
