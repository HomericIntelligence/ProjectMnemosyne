...
description: 'Handle PR review plans that report no issues and no fixes required.
  Use when: review plan says ''No problems found'', automated feedback reports clean
  PR, or CI is pending but no code changes needed.'
