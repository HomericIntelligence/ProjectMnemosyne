...
description: 'Documents the ExTensor view/owner contract for Mojo ML frameworks. Use
  when: (1) documenting shared-ownership tensor semantics, (2) fixing MD060 table-column-style
  errors, (3) expanding view contract docs with refcount lifecycle details.'
