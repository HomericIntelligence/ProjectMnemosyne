...
description: 'Replace unverifiable curl|sh installer patterns in CI with the setup-pixi
  composite action to eliminate supply-chain risk. Use when: a workflow installs a
  runtime or CLI tool via curl -s <url> | sh without hash verification.'
category: ci-cd
date: 2026-03-15
version: 1.0.0
