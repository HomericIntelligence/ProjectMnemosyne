...
description: 'Document pre-commit hook OS/runtime incompatibilities in CONTRIBUTING.md.
  Use when: a hook auto-skips due to host OS constraints but lacks a discoverable
