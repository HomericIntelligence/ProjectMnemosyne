...
description: 'Fix incomplete GitHub Actions composite action migration and redundant
  double-caching. Use when: jobs still call a third-party action directly instead
  of using a composite wrapper, or a composite action duplicates caching the wrapped
  action already handles.'
category: ci-cd
date: 2026-03-05
version: 1.0.0
