...
description: 'Handle PR review fix plans that conclude no changes are required. Use
  when: a .claude-review-fix-*.md file says no fixes needed, or when verifying a PR
