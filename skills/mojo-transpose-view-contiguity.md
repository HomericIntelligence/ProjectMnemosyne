...
description: 'Add stride-based transpose_view() to Mojo ExTensor for testing contiguity
  contracts. Use when: tests use direct _strides mutation, needing realistic non-contiguous
  tensors for is_contiguous()/as_contiguous() tests.'
category: testing
date: 2026-03-07
version: 1.0.0
