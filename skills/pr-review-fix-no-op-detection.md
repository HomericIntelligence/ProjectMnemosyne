...
description: 'Detect when a PR review-fix plan requires no code changes and verify
  the fix commit is pushed. Use when: fix plan says no action needed, CI shows stale
  failures after a fix commit, or verifying whether a format fix was pushed.'
category: ci-cd
date: 2026-03-05
version: 1.0.0
