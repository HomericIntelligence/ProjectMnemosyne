...
description: Zero-dependency pattern for adding a pygrep pre-commit hook that blocks
  commits if banned phrases appear in source files. Covers regex design, ruff D301
  fix, and test strategy.
category: ci-cd
date: 2026-03-03
version: 1.0.0
