...
| **Root Cause** | judges\_df with 7,236 rows exceeded Altair's hard limit for Vega-Lite specs |
...
### 3. Handle Multi-Facet Figures (e.g., fig14 with pair\_label + agent\_model)
...
- Altair documentation: https://altair-viz.github.io/user\_guide/data.html#maxrows
