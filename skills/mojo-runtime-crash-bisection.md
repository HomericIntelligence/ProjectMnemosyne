...
description: 'Systematic approach for bisecting Mojo runtime crashes to create minimal
  reproducers and isolate root causes. Use when: Mojo crashes in runtime libraries,
  need upstream bug reports.'
category: debugging
date: 2026-03-16
version: 1.0.0
