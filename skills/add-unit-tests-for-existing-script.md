...
description: 'Add comprehensive pytest unit tests for an existing Python script with
  no coverage. Use when: a script has no tests, bugs were found during implementation,
  or a follow-up issue requests test coverage.'
category: testing
date: 2026-03-07
version: 1.0.0
