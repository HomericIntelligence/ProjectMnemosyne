...
description: 'Add timeout monitoring guidance comments to GitHub Actions matrix entries.
  Use when: (1) a CI matrix has a shared timeout and groups may approach the limit,
  (2) groups grew after consolidation and risk timing out, (3) you want to document
  split thresholds and file counts inline without changing runtime behavior.'
category: ci-cd
date: 2026-03-07
version: 1.0.0
