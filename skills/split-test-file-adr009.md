...
description: 'Split a Mojo test file exceeding the ADR-009 fn test_ function limit
  into multiple smaller files. Use when: (1) a .mojo test file has >10 fn test_ functions
  causing CI heap corruption, (2) CI shows intermittent libKGENCompilerRTShared.so
  JIT faults.'
category: ci-cd
date: 2026-03-07
version: 1.0.0
