...
description: 'Parallel rebase and CI fix workflow for multiple stale PRs using worktree
  agents. Use when: many PRs behind main, batch PR maintenance after merge waves,
  iterative CI diagnosis.'
category: ci-cd
date: 2026-03-18
version: 1.0.0
