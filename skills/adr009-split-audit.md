...
description: 'Audit ADR-009 test file splits to verify no tests were silently dropped.
  Use when: (1) investigating whether a test file split omitted any test functions,
  (2) auditing test coverage after ADR-009 heap-corruption workaround splits, (3)
  verifying that all tests from a deprecated file are present in successor split files.'
category: testing
date: 2026-03-15
version: 1.0.0
