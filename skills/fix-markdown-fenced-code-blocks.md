...
description: 'Fix malformed fenced code block closings and markdownlint violations
  in markdown files. Use when: closing fences have language tags, line-length violations
  in docs, or lists lack surrounding blank lines.'
