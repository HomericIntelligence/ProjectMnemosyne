...
description: 'Workflow for safely deleting deprecated files from a Mojo/Python codebase.
  Use when: (1) a file is marked DEPRECATED and consolidated elsewhere, (2) cleaning
  up legacy modules after migration, (3) removing files as part of a cleanup GitHub
  issue.'
category: tooling
date: 2026-03-05
version: 1.0.0
