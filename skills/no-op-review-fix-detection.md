...
description: 'Recognize when a review-fix plan requires zero implementation changes
  and verify the worktree is already correct. Use when: a .claude-review-fix-*.md
  plan explicitly states no fixes are required.'
category: tooling
date: 2026-03-05
version: 1.0.0
