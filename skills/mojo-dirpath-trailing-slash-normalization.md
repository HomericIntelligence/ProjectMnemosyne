...
description: 'Fix double-slash path construction in Mojo when dirpath has a trailing
  slash. Use when: (1) save_named_tensors/load_named_tensors produces paths like ''checkpoint//file.weights'',
  (2) os.listdir or file open fails due to double slashes, (3) docstring examples
  show trailing slash but function concatenates ''/'' + filename unconditionally.'
category: debugging
date: 2026-03-15
version: 1.0.0
