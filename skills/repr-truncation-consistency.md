...
description: 'Apply NumPy-style truncation to __repr__ for consistency with __str__.
  Use when: a class has truncated __str__ but untruncated __repr__, or repr() on large
  objects causes performance issues.'
category: debugging
date: 2026-03-15
version: 1.0.0
