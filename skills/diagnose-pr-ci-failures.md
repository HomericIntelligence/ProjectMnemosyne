...
description: 'Diagnose CI failures on a pull request by classifying them as PR-caused,
  pre-existing, or flaky, then act accordingly. Use when: CI checks fail after pushing
  a PR and you need to determine root cause and correct action.'
category: ci-cd
date: 2026-03-05
version: 1.0.0
