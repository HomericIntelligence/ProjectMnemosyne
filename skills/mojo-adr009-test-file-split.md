...
description: "Split Mojo test files exceeding the ADR-009 limit of \u226410 fn test_\
  \ functions per file to prevent heap corruption crashes. Use when: test file has\
  \ >10 fn test_ functions, CI fails intermittently with libKGENCompilerRTShared.so\
  \ JIT fault, or implementing ADR-009."
category: testing
date: 2026-03-07
version: 1.0.0
